...
std::wstring CPythonStackController::GetReferenceFileName()
{
...
std::wstring CPythonStackController::GetReferenceFunctionName()
{
	PyThreadState* ts = PyThreadState_Get();
	PyFrameObject* frame = ts->frame;
...
void CPythonStackController::SendViolationMessage(int32_t iTypeId, const std::wstring& szRefFileName, const std::wstring& szRefFuncName)
{
#ifdef _DEBUG
...
void CPythonStackController::CheckStackReferenceEx(int32_t iTypeId, const std::wstring& szRefFileName, const std::wstring& szRefFuncName)
{
...
void CPythonStackController::CheckStackReference(int32_t iTypeId, const std::wstring& szRefFileName, const std::wstring& szRefFuncName)
{
